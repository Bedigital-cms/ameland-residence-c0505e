...
const paths: Record<string, string> = {
  ...
  // villa key facts — same 24x24 line style as the rest of the set
  users: 'M9 11a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7zm7.5 0a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM2.5 20v-1.5A4.5 4.5 0 0 1 7 14h4a4.5 4.5 0 0 1 4.5 4.5V20m2-6.8A4 4 0 0 1 21.5 17v3',
  bed: 'M3 19v-9m0 4h18v5M3 14a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3M21 14v-3a3 3 0 0 0-3-3h-5',
  paw: 'M6.5 12.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm11 0a2 2 0 1 0 0-4 2 2 0 0 0 0 4zM10 8.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm4 0a2 2 0 1 0 0-4 2 2 0 0 0 0 4zM12 13c2.5 0 4.5 1.8 4.5 4a2.5 2.5 0 0 1-2.5 2.5h-4A2.5 2.5 0 0 1 7.5 17c0-2.2 2-4 4.5-4z',
  plug: 'M9 3v5m6-5v5M6.5 8h11v3a5.5 5.5 0 0 1-5.5 5.5A5.5 5.5 0 0 1 6.5 11V8zM12 16.5V21',
